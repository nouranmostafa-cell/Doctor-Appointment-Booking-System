        ...
        {appointments.slice(0, 3).map((item, index) => (
          ...
          >
            ...
            <div className="flex flex-col gap-2 justify-end text-right">
              {!item.cancelled && (
                <button className="text-sm text-stone-500 text-center sm:min-w-48 py-2 border rounder hover:bg-primary hover:text-white transition-all duration-300">
                  Pay Online
                </button>
              )}
              {!item.cancelled && (
                <button
                  ...
                  className="text-sm text-stone-500 text-center sm:min-w-48 py-2 border rounder hover:bg-red-600 hover:text-white transition-all duration-300"
                >
                  Cancel Appointment
                </button>
              )}
